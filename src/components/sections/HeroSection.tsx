...
const Hero3DCanvas = dynamic(() => import('@/components/3d/Hero3DCanvas'), {
  ssr: false,
  loading: () => <div className="w-full h-full bg-dark-card/50 rounded-3xl animate-pulse" />,
});
...
export default function HeroSection({ onOpenQuote }: HeroSectionProps) {
  ...
  return (
    <section className="relative min-h-[90vh] pt-28 pb-16 md:pt-36 md:pb-20 flex items-center bg-navy-gradient overflow-hidden z-10 text-light-bg">
      ...
      <div className="absolute top-1/4 left-10 w-96 h-96 bg-warm-orange/10 rounded-full blur-3xl pointer-events-none z-0" />
      <div className="absolute bottom-10 right-10 w-96 h-96 bg-orange-light/10 rounded-full blur-3xl pointer-events-none z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          >
            ...
            {/* Credibility Badges */}
            <div className="pt-6 border-t border-dark-border/60 flex items-center gap-6 text-xs text-offwhite-muted">
              <div className="flex items-center gap-2">
                <ShieldCheck className="w-4 h-4 text-warm-orange" />
          ...
          <motion.div
            ...
            className="lg:col-span-5 h-[380px] sm:h-[450px] lg:h-[500px] relative rounded-3xl overflow-hidden border border-dark-border bg-gradient-to-b from-dark-card to-near-black shadow-premium z-10"
          >
            <Hero3DCanvas />
          </motion.div>
        ...
        <div className="mt-12 flex justify-center">
          ...
          >
            <span className="uppercase tracking-widest text-[10px]">Explore Showcase</span>
